...
var richText = new PIXI.Text('Happy Birthday Dhara', style)
...
var lowText = new PIXI.Text('You can close this for now', style)
lowText.x = window.innerWidth - 200 - lowText.getBounds().width / 2
lowText.y = window.innerHeight - 50  - lowText.getBounds().height / 2
